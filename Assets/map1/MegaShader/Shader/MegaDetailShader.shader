...
///////// Gloss:
                ...
                float gloss = (_MaskMixerrgb_AOa_var.a*saturate(lerp(lerp(saturate((node_7930+(node_7930/node_9856))),saturate(_Dirt_Gloss),node_9525),(_BaseSpecColGlossa_var.a*_Base_Gloss),_Base_Gloss)));
                float perceptualRoughness = 1.0 - (_MaskMixerrgb_AOa_var.a*saturate(lerp(lerp(saturate((node_7930+(node_7930/node_9856))),saturate(_Dirt_Gloss),node_9525),(_BaseSpecColGlossa_var.a*_Base_Gloss),_Base_Gloss)));
...
////// Specular:
                ...
                float3 node_6678 = (_Base_Color.rgb*saturate((((lerp(node_6078,_Mask1_color.rgb,_Detail1_strength)*(_MaskMixerrgb_AOa_var.r*lerp(float3(1,1,1),_Detail_Map1_var.rgb,_Detail1_strength)))+(lerp(node_6078,_Mask2_color.rgb,_Detail2_strength)*(_MaskMixerrgb_AOa_var.g*lerp(float3(1,1,1),_Detail_Map2_var.rgb,_Detail2_strength))))+(lerp(node_6078,_Mask3_color.rgb,_Detail3_strength)*(_MaskMixerrgb_AOa_var.b*lerp(float3(1,1,1),_Detail_Map3_var.rgb,_Detail3_strength))))));
                float3 node_3980 = (lerp(((_MaskMixerrgb_AOa_var.a*(_MaskMixerrgb_AOa_var.a*_AO_boost))*_Base_Texture_var.rgb*node_6678),((node_571+(1.0 - (node_8148*float3(0,1,0))))*_Dirt_Color.rgb),node_9525)*_MaskMixerrgb_AOa_var.a);
                float3 diffuseColor = lerp(_Base_Texture_var.rgb,node_3980,_Dirt_Color.a); // Need this for specular when using metallic
